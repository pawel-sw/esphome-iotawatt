...
PHASE_TABLES = {
    ...
    "Jameco/112336": {"p60": [0.6], "base": 0.6},
    "JW-95001-NA": {"p60": [0.74], "base": 0.74},
    "Ideal 77DE-06-09(EU)": {"p50": [1.46], "p60": [0.82], "base": 0.82},
    "Ideal 77DB-06-09(UK)": {"p50": [1.05], "base": 1.05},
    "TDC DA-10-09-E6": {"p60": [0.07], "base": 0.07},
    "Jameco/2270815": {"p60": [0.16], "base": 0.16},
    "M9233": {"p50": [1.81], "base": 1.81},
    "DCSS AC910(Aus)": {"p50": [2.17], "base": 2.17},
    "Powertech MP-3027(Aus)": {"p50": [0.92], "base": 0.92},
    "Ideal 77DE-06-09-V(EU)": {"p50": [0.82], "p60": [0.46], "base": 0.46},
    "Ideal 77DE-06-09-VI(EU)": {"p50": [0.82], "p60": [0.36], "base": 0.36},
    "Ideal 77DA-10-09-MI(USA)": {"p60": [0.10], "base": 0.10},
    "TDC DE-10-09(EU)": {"p50": [0.16], "base": 0.16},
    "Jameco/100061": {"p60": [3.00], "base": 3.00},
    "Jameco/102234": {"p60": [1.80], "base": 1.80},
    "Jameco/2227444": {"p60": [0.58], "base": 0.58},
    "CUI 41A-9-1000": {"p60": [0.43], "base": 0.43},
    "AX-27750-H": {"p60": [0.18], "base": 0.18},
    "TDC DA-10-09": {"p60": [1.14], "base": 1.14},
    
    # CT (Current Transformers)
    "AcuCT-H040-50": {"p60": [1.1, 8, 1.0, 17, 0.9], "p50": [1.4, 3, 1.3, 6, 1.2, 10, 1.1, 17, 1.05, 40, 1.1], "base": 1.0},
    "AcuCT-H063-100": {"p60": [0.7, 15, 0.6, 45, 0.55], "p50": [0.8, 12, 0.7, 32, 0.6], "base": 0.6},
    "AcuCT-H100-200": {"p60": [0.3, 30, 0.25], "p50": [0.3, 50, 0.25], "base": 0.25},
    "AcuCT-H138-400": {"p60": [0.25, 10, 0.2, 30, 0.15], "p50": [0.3, 20, 0.2, 80, 0.15, 160, 0.10], "base": 0.15},
    "AcuCT-H138-600": {"p60": [0.1, 60, 0.05], "p50": [0.15, 20, 0.1, 100, 0.05], "base": 0.1},
    "SCT006-000": {"base": 4.6},
    "SCT010-000": {"p60": [1.8, 2, 1.7, 8, 1.6, 15, 1.5, 35, 1.6, 45, 1.7], "p50": [2.1, 4, 2.0, 8, 1.9, 12, 1.8, 30, 1.9, 40, 2.1], "base": 1.75},
    "SCT013-000": {"p60": [2.7, 4, 2.6, 8, 2.5, 12, 2.4, 18, 2.3, 30, 2.2, 44, 2.1], "p50": [3.1, 4, 3.0, 8, 2.9, 12, 2.8, 17, 2.7, 26, 2.6, 38, 2.5], "base": 2.3},
    "SCT019-000": {"p60": [2.6, 3, 2.4, 5, 2.2, 10, 2.1, 18, 2.0, 35, 1.9], "p50": [3.2, 4, 3.0, 6, 2.8, 8, 2.7, 12, 2.6, 22, 2.5], "base": 1.8},
    "SCT023R": {"base": 0.8},
    "SCT027H": {"base": 2.0},
    "ECOL09": {"p60": [0.4, 20, 0.3], "p50": [0.5, 20, 0.4], "base": 0.10},
    "ECS1050": {"p60": [2.0, 1, 1.9, 2, 1.8, 3, 1.7, 6, 1.6, 12, 1.5, 21, 1.4], "p50": [2.2, 3, 2.1, 4, 2.0, 8, 1.9, 13, 1.8], "base": 1.6},
    "ECS16100": {"p60": [0.9, 7, 0.8, 30, 0.72], "p50": [1.2, 6, 1.1, 19, 1.0, 50, 0.95], "base": 0.6},
    "ECS24200": {"p60": [0.5, 20, 0.45, 55, 0.40], "p50": [0.8, 10, 0.7, 20, 0.6, 55, 0.55], "base": 0.2},
    "ECS25200-C2": {"p60": [1.1, 6, 1.0, 12, 0.9, 28, 0.8], "p50": [1.2, 8, 1.1, 18, 1.0, 36, 0.9], "base": 1.7},
    "ECS24300": {"p60": [0.5, 10, 0.4, 30, 0.3, 90, 0.25], "p50": [0.8, 10, 0.6, 30, 0.5, 90, 0.45], "base": 0.3},
    "ECS24400": {"p60": [0.5, 10, 0.4, 30, 0.3, 90, 0.25], "p50": [0.8, 10, 0.6, 30, 0.5, 90, 0.45], "base": 0.3},
    "ECS36400": {"p60": [0.1], "p50": [0.2, 10, 0.1], "base": 0.1},
    "ECS50600": {"p60": [0.4, 45, 0.35, 90, 0.3], "p50": [0.7, 20, 0.6, 35, 0.55], "base": 0.3},
    "ECSL55800": {"p60": [0.3, 12, 0.2, 40, 0.1], "p50": [0.6, 12, 0.3, 24, 0.2, 40, 0.15], "base": 0.1},
    "ECS80-800": {"base": 0.2},
    "ECS80-1200": {"base": 0.2},
    "ECS120-2000": {"base": 0.2},
    "CR3110-3000": {"base": 1.85},
    "WC-1": {"base": 1.6},
    "HWCT-004": {"p60": [0.4, 10, 0.3], "p50": [0.6, 10, 0.5], "base": 0.1},
    "DL-CT08CL2": {"p60": [0.2, 5, 0.1], "p50": [0.2, 5, 0.1, 15, 0.05], "base": 0.1},
    "AZ500": {"p60": [3.0, 1.5, 3.5, 2.5, 3, 4, 2.5, 6.5, 2, 11, 1.5], "p50": [3.5, 2, 3.0, 3, 2.5, 5, 2.0, 10, 1.5, 20, 1.25], "base": 1.5},
    "AZ1000": {"p60": [1.5, 1, 1.25, 3, 1.0, 9, 0.75, 22, 0.5], "p50": [1.75, 2, 1.5, 3, 1.25, 7, 1.0, 17, 0.75, 33, 0.6], "base": 0.75},
    "Micro-40": {"p60": [3, 1, 2.5, 2, 2, 5, 1.5, 12, 1], "p50": [4, 2.5, 3.5, 3.5, 3, 5, 2.5, 7, 2, 12, 1.5, 35, 2], "base": 1.5},
    "ZDKCT10M": {"base": 1.5},
    "PZCT-02": {"base": 2.5},
    "SCT0750-000": {"base": 2.55},
    "SCT013-030": {"base": 3.8},
    "SCT013-050": {"base": 3.0},
}
...
BASE_INPUT_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_CAL, default=1.0): cv.float_,
        cv.Optional(CONF_PHASE): cv.float_,
        cv.Optional(CONF_TURNS, default=1.0): cv.float_,
...
async def to_code(config):
    ...
    for input_conf in config[CONF_INPUTS]:
        ...
        cal = input_conf[CONF_CAL]
        phase = input_conf.get(CONF_PHASE, None)
        turns = input_conf[CONF_TURNS]
